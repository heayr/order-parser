...
import parseOrderDetails from './parserOrderDetails';
    ...
    <div className="order-parser">
      ...
      <form onSubmit={handleSubmit}>
        <textarea
          ...
          cols="80"
          placeholder="Вставьте сюда текст заказа"
          className="order-textarea text-black placeholder-slate-500"
        />
      ...
      <div className="order-cards-container">
        {orders.map((order, index) => (
          <OrderCard key={index} orderInfo={order} />
        ))}
      </div>
    </div>
  );
